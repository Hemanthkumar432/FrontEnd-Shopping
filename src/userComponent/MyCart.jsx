...
const MyCart = () => {
  ...
  const retrieveMyCart = async () => {
    const response = await axios.get(
      "https://determined-playground-production.up.railway.app/api/user/mycart?userId=" + user.id
    );
  ...
  const deleteProductFromCart = (cartId, e) => {
    const response = axios.get(
      "https://determined-playground-production.up.railway.app/api/user/mycart/remove?cartId=" + cartId
    );
