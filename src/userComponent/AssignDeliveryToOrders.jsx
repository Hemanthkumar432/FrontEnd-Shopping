...
const AssignDeliveryToOrders = () => {
  ...
  const retrieveAllDeliveryPerson = async () => {
    const response = await axios.get(
      "https://determined-playground-production.up.railway.app/api/user/deliveryperson/all"
    );
  ...
  const retrieveAllOrder = async () => {
    const response = await axios.get(
      "https://determined-playground-production.up.railway.app/api/user/admin/showorder?orderId=" + orderId
    );
  ...
  const assignDeliveryToOrders = (e) => {
    fetch("https://determined-playground-production.up.railway.app/api/user/admin/order/assignDelivery", {
      method: "POST",
      headers: {
                  ...
                  return (
                    <tr>
                      ...
                      <td>
                        <img
                          src={
                            "https://determined-playground-production.up.railway.app/api/product/" +
